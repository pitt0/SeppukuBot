...
REEL = [Reel.Watermelon, Reel.Cherry, Reel.Kiwi, Reel.Diamond, Reel.Banana, Reel.Cherry, Reel.Banana, Reel.Kiwi, Reel.Watermelon, Reel.Cherry, Reel.Banana, Reel.Watermelon, Reel.Kiwi]
...
class SlotsGame:
    ...
    def __init__(self, interaction: discord.Interaction) -> None:
        self._reels = [Reel.Rolling, Reel.Rolling, Reel.Rolling]
    ...
    @property
    def reels(self) -> str:
        return f'{self._reels[0].value}|{self._reels[1].value}|{self._reels[2].value}'
